Single-\/event fitter replicates \mbox{\hyperlink{classlf__allfit}{lf\+\_\+allfit}} with the option to use direct bonsai functions or via the bonsaifit function in bscalls.\+cc.
