...
***********************************************************************/
  ...
  for(row=0; row<nrhits; row++)
    for(column=row+1; column<nrhits; column++)
      {
	cone_intersect(cos_theta,hit_vectors+3*row,hit_vectors+3*column,
		       directions+4*nrdir,
...
/***********************************************************************
 *    -------------------------------------                            */
void ariadne::cone_intersect(float cos_theta,float *axis1,float *axis2,
			     float *dir1,float *dir2,int &solution)  //*
{ //                                                                   *
/*    -------------------------------------                            *
 *                                                                     *
 *    (Purpose)                                                        *
...
void ariadne::find_largest_cluster(float &limit,int &max_index,float &maxmag,
				   int &nradd,int &clus_index)
{
  int row;
...
void ariadne::refine_cluster(float &limit,int &max_index,float &maxmag,int &nradd,
			     int &clus_index)
{
  int i;
...
void ariadne::final_scan(float limit,int &max_index,float &maxmag,int &nradd,
			 int &clus_index)
{
  float tempdir[4];
  int i;
