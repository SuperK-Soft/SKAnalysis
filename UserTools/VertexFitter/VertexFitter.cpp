...
bool VertexFitter::Execute(){
    ...
    if (dataSrc == 0) {
        // Get the hit information stored in the common blocks (skt_/skq_) - preferred method
    ...
    std::cerr<<"yes"<<std::endl;
        ...
        if (bsvertex[0]<9999) {
            ...
            if (bswallsk>0.0){
                ...
                if (skroot_lowe_.bsdirks != -1) {
                    // final calculation of bsdirks if initial direction fit was successful
