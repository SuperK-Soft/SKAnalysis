...
CXXFLAGS += -fmax-errors=5 -fPIC -O3 -g -std=c++17 -lgfortran -malign-double -mpreferred-stack-boundary=8 -fdiagnostics-color=always -Wno-reorder -Wno-sign-compare -Wno-unused-variable -Wno-unused-but-set-variable -Wno-sign-compare -Werror=array-bounds -Werror=return-type # -Wpadded -Wpacked -Wpedantic << too many pybind warnings?
